...
public class MoneyConvertUtil {
    ...
    public static void main(String[] args) {
        String number = "1";
        System.out.println(number + " " + MoneyConvertUtil.toChinese(number));
        ...
        number = "12";
        System.out.println(number + " " + MoneyConvertUtil.toChinese(number).split("元")[0]);
