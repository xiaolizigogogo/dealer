 ...
 * 获取中文首字母
 * <p/>
 * Created by FuYung on 2015/6/17.
 */
public class ChineseInitialsUtil {
    ...
    public static String getPYIndexStr(String strChinese, boolean bUpCase) {
        try {
            ...
            for (int i = 0; i < b.length; i++) {
                if ((b[i] & 255) > 128) {
                    int char1 = b[i++] & 255;
                    char1 <<= 8;//左移运算符用“<<”表示，是将运算符左边的对象，向左移动运算符右边指定的位数，并且在低位补零。其实，向左移n位，就相当于乘上2
                    // 的n次方
    ...
    public static void main(String[] args) {
        System.out.println(ChineseInitialsUtil.getPYIndexStr("南城", true));
    }
}
