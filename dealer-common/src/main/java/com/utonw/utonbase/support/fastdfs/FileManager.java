package com.utonw.utonbase.support.fastdfs;

import com.alibaba.fastjson.JSON;
import com.utonw.utonbase.core.util.PropertiesUtil;
import com.utonw.utonbase.csource.common.NameValuePair;
import com.utonw.utonbase.csource.fastdfs.*;
import com.utonw.utonbase.csource.fastdht.FastDHTClient;
import com.utonw.utonbase.csource.fastdht.KeyInfo;
...
public class FileManager implements Config {
	...
	static { // Initialize Fast DFS Client configurations
		try {
			...
			com.utonw.utonbase.csource.fastdht.ClientGlobal.init(path + "fdht_client.conf");
		} catch (Exception e) {
			logger.error("", e);
		}
	}
