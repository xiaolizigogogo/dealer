package com.utonw.utonbase.csource.common;
...
import com.utonw.utonbase.core.util.MathUtils;
...
public class Money implements Serializable, Comparable<Money> {
	...
	public Money(String amount, Currency currency) {
		// 如果金额为null，宁愿让它报错
		this(new BigDecimal(amount == null ? null : amount.trim()), currency);
	}
	 ...
	 * <br>
	 * 返回一个新的货币对象，币种与本货币对象相同，金额为本货币对象的金额乘以乘数。
	 * 本货币对象的值不变。如果相乘后的金额不能转换为整数分,则直接舍去小数位
	 * 
	 * @param val
	 * @return
	 */
	 ...
	 * <br>
	 * 返回一个新的货币对象，币种与本货币对象相同，金额为本货币对象的金额乘以乘数。
	 * 本货币对象的值不变。如果相乘后的金额不能转换为整数分,则如果分后面大于0，则直接进位
	 * 
	 * @param val
	 * @return
	 */
	 ...
	 * <p>
	 * 返回一个新的货币对象，币种与本货币对象相同，金额为本货币对象的金额除以除数。
	 * 本货币对象的值不变。如果相除后的金额不能转换为整数分，则直接舍去小数位
	 * 
	 * @param val
	 * @return
	 */
