...
<div style="background:#eee;">
    ...
    <div class="from_box distribution_user">
        <div class="from_tit clearfix">
        ...
        <div class="from_box distribution_user">
            ...
            <div id="distpicker" class="from_con clearfix">
                <dl class="dl-horizontal col-sm-8">
                    ...
                    <dd><select class="form-control col-sm-4" name="province"
                                style="width:240px; margin-right:10px;"></select>
                        <select class="form-control col-sm-4" name="city"
                                style="width:240px; margin-right:10px;"></select>
                        <select class="form-control col-sm-4" name="district"
                                style="width:240px; margin-right:10px;"></select>
                    </dd>
                </dl>
                <dl class="dl-horizontal col-sm-3">
                    <dt><i class="text-danger">*</i> 线下分配人员</dt>
                    <dd><select class="form-control" name="userid">
...
<script>
    ...
    $("#evaluateForm").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                type: 'post',
                url: "${basePath}/admin/merchant/evaluateInfo",
    ...
    function attchmentAndcontract(param) {
        ...
        if (param.fileName != "12" && param.fileName != "13" && param.fileName != "14") {
            html += "<li>"
                + "<div class='file_img'>"
                + "<p class='tools'></p>"
                + "<img class='example-image' src=" + param.fileUrl + "></a> </div>"
