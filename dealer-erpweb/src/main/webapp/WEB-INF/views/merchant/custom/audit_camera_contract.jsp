...
<div style="background:#eee;">
    ...
    <div class="from_box">
				<div class="from_tit clearfix">
					<h3 class="pull-left">利率、单车比例、最高贷款额度</h3>
				</div>
				<dl class="dl-horizontal col-sm-4">
					...
					<dd>
						<div class="input_group" style="max-width: 120px">
							<input maxlength="8" style="width: 100%;" class="form-control valid" value="" type="text" id="input1" readonly> <span class="danwei">%</span>
						</div>
					</dd>
				</dl>
				<dl class="dl-horizontal col-sm-4">
					...
					<dd>
						<div class="input_group" style="max-width: 120px">
							<input maxlength="8" style="width: 100%;" class="form-control valid" value="" type="text" id="input2" readonly> <span class="danwei">%</span>
						</div>
					</dd>
				</dl>
				<dl class="dl-horizontal col-sm-4">
					...
					<dd>
						<input type="text" name="remark" class="form-control" id="input3" readonly>
					</dd>
				</dl>
			</div>
            ...
            <div class="from_con clearfix">
                <dl class="dl-horizontal col-sm-4">
                    ...
                    <dd>
                        ...
                        <input type="radio" value="back_installCamera_signContract" name="status">回退上一节点</input>
                    </dd>
                </dl>
            </div>
            <div class="from_con clearfix">
                <dl class="dl-horizontal col-sm-4">
                    <dt><i class="text-danger">*</i>&nbsp;意见</dt>
                    <dd>
    ...
    $("#evaluateForm").validate({
        ...
        submitHandler: function (form) {
            layer.confirm("是否确认提交?", {icon: 3, title: '提示'}, function () {
                ...
                $.ajax({
                    type: 'post',
                    url: "${basePath}/admin/merchant/auditCameraContract",
