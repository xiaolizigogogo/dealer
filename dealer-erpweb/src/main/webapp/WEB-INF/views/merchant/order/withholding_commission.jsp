...
<div class="op_box" id=" op_box_first_trial">
	...
	<div class="op_box_con clearfix">
		状态：<span class="text-value" data-key="loanStatus"></span>
	</div>
</div>
</div>
<div class="modal-footer">
	...
	<p class="col-sm-2">
		<a href="javascript:void(0)" onclick="submitReview()"
		   class="btn btn-danger btn-block" id="commit">进行第三方代扣</a>
	</p>
</div>
</body>
...
<script>
 ...
 function contact(param1,param2){
	...
	function submitReview() {
		...
		//获取选中的评审结论
		var dialogMsg = "确认<font color='red'>进行第三方代扣</font>吗？";
		alertMessage(dialogMsg, 'submit("' + param + '")', 'qs_box1');
	}
	function submit(param) {
		$.ajax({
			type : "post",
			url : "/admin/order/withholdingCommissionHandler",
