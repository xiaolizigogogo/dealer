				...
				<form class="form-horizontal" id="form_first_trial">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"><i
								class="text-danger">*</i>车辆审批价格(万元)</label>
						<div class="col-sm-8">
							<input  class="form-control" type="number"
									id="approvalAmount" name="approvalAmount" style="max-width:100px"></input>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label"><i
...
$("#div_obd").hide();
 ...
 function contact(param1,param2){
	...
	function submitReview() {
		...
		if(approvalConclusion==null||approvalConclusion==""){
			layer.msg("审批金额不能为空！");
			return false;
		}
		var param = "&taskId=" + $("#task_id").val() + "&orderId="
				+ $("#indent_uuid").val() + "&approvalLevel="
				+ $("#flowStatus_select").val()+"&approvalAmount="+$("#review_money").html();
