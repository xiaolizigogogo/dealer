...
<div class="modal-body" >
  <ol class="ui-step ui-step-red ui-step-6" id="processBar">
  </ol>
    ...
    <div class="tab-content clearfix">
      <div role="tabpanel" class="tab-pane active" id="tab1">
        ...
        <div class="from_box">
          ...
          <div id="assign"></div> <br>
            <div data-toggle="distpicker">
              <select data-province="---- 选择省 ----" class="form-control col-sm-3" name="province" style="width=240px; margin-right:10px;"></select>
              <select data-city="---- 选择市 ----" class="form-control col-sm-3" name="province" style="width=240px; margin-right:10px;"></select>
              <select data-district="---- 选择区 ----" class="form-control col-sm-3" name="province" style="width=240px; margin-right:10px;"></select>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-12">
            <div class="from_box">
              ...
              <div class="img_list" id="contract">
                <ul class="list-inline" id="dowebok"></ul>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="op_box" id="op_box_datareview" style="display:none">
    ...
    <div class="op_box_con clearfix">
      <form class="form-horizontal" id="form_datareview">
        <div>
          <div class="form-group">
            <div class="col-sm-8  col-sm-offset-2"> <a href="#tab7" aria-controls="tab7" role="tab" data-toggle="tab"  id="file_more">查看全部附件</a> </div>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <textarea cols="168" rows="2" class="form-control" id="approval_datareview"
  ...
  <div class="op_box" id="op_box_judgment" style="display:none">
    <h4>终审</h4>
    <div class="op_box_con clearfix">
      <form class="form-horizontal" id="form_judgment">
        <div class="form-group">
          <label  class="col-sm-2 control-label"><i class="text-danger">*</i> 上传质押合同</label>
          <div class="col-sm-2">
            <div><a href="javascript:;" class="file">选择文件<input id="up_img_WU_FILE_judgment" type="file" ></a></div>
            <a id="link_judgment" class='example-image-link' href="" data-lightbox='example-0' data-title='' style='color:#bda477;text-decoration:none;' >
              <p class="file_img"><img class='example-image-link' id="imgShow_WU_FILE_judgment"/></p>
            </a>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <label class="radio-inline">
              <input type="radio" name="approvalStatus" id="inlineRadio3" value="pass" checked="checked">
              通过 </label>
            <label class="radio-inline">
              <input type="radio" name="approvalStatus" id="inlineRadio4" value="nopass">
              不通过 </label>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <div class="input-group input-append bootstrap-timepicker" style="width:120px">
              <input type="text" class="form-control"  value="0"  name="approvalAmount" id="approval_amount">
        ...
        <div class="form-group">
          <label  class="col-sm-2 control-label"><i class="text-danger">*</i> 意见</label>
          <div class="col-sm-8">
            <textarea cols="168" rows="2" class="form-control" id="approval_judgment"
                      name="approvalConclusion"></textarea>
          </div>
        </div>
      </form>
  ...
  <div class="op_box"  id="op_box_lended" style="display:none">
    <h4>出账</h4>
    <div class="op_box_con clearfix">
      <form class="form-horizontal" id="form_lended">
        <div class=" col-sm-8">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <div class="input-group date form_date" data-date=""
                   ...
                   data-link-format="yyyy-mm-dd" style="width:180px;">
                <input class="form-control" type="text" value="" readonly style="width:100%;" id="lended_time" name="lendedTime">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <a href="javascript:;" class="file">选择文件<input id="up_img_WU_FILE_lended" type="file" ></a>
              <a id="link_lended" class='example-image-link' href="" data-lightbox='example-0' data-title='' style='color:#bda477;text-decoration:none;' >
                <p class="file_img"><img class='example-image-link' id="imgShow_WU_FILE_lended" /></p>
              </a>
            </div>
          </div>
          <div class="form-group">
            <label  class="col-sm-2 control-label"><i class="text-danger">*</i> 意见</label>
            <div class="col-sm-10">
              <textarea cols="168" rows="2" class="form-control" id="approval_lended"
                        name="approvalConclusion" style="display:block;"></textarea>
            </div>
          </div>
        </div>
      </form>
...
<script>
    ...
    //流程状态
    var processDefinitionId = $("#flowStatus_select").val();
    function init(){
        //根据流程状态显示特定div
   ...
   /* function attchmentAndcontract(param){
    ...
    function submitReview(){
        // 审批意见
        var approvalConclusion = $("#approval_"+ processDefinitionId).val();
        var imageShow="";
        var dialogList={};
        if(processDefinitionId==flowStatusList["总部复核"]){
            if($("#form_"+ processDefinitionId).find("input:radio[name=approvalStatus]:checked").val()=="pass"){
                dialogList['diaglog']="通过";
            }else{
                dialogList['diaglog']="不通过";
            }
        }
        if(processDefinitionId==flowStatusList["终审"]){
            imageShow = $("#imgShow_WU_FILE_"+processDefinitionId)[0].src;
            if(imageShow==""||imageShow==null){
                layer.msg("质押合同不能为空！");
                return false;
            }
            if($("#form_"+ processDefinitionId).find("input:radio[name=approvalStatus]:checked").val()=="pass"){
                dialogList['diaglog']="复核通过";
            }else{
                dialogList['diaglog']="复核不通过";
            }
            var approvalAmount = $("#approval_amount").val();
            if(approvalAmount=="" || approvalAmount==null){
                layer.msg("审批金额不能为空！");
                return false;
            }
        }
        if(processDefinitionId==flowStatusList["放款"]){
            debugger;
            imageShow = $("#imgShow_WU_FILE_"+processDefinitionId)[0].src;
            if(imageShow==""||imageShow==null){
                layer.msg("出账凭证不能为空！");
            ...
            dialogList['diaglog']="上传出账凭证无误";
        }
        if(approvalConclusion=="" || approvalConclusion==null){
            layer.msg("审批意见不能为空！");
            return false;
        }
        var param  = "&taskId="+$("#task_id").val()+"&orderId="+$("#indent_uuid").val()+"&approvalLevel="+processDefinitionId+"&lendedPic="+imageShow;
        //获取选中的评审结论
        var dialogMsg = "确认<font color='red'>"+dialogList['diaglog']+"</font>吗？";
    ...
    function submit(param){
        $.ajax({
            ...
            data:$("#form_"+ processDefinitionId).serialize()+param,
            dataType:"json",
            success:function(data){
                debugger;
                if(data.success){
