...
<body>
	...
	<div class="col-sm-12 row">
      <div class="col-sm-4">
        <ul>
          <li><a href="#" onclick="assignment(this)" id="">未处理的贷前订单</a> <span class="badge"  id="noloanordercountdisplay">0</span></li>
        </ul>
      </div>
      <div class="col-sm-4">
        <ul>
          <li class="active" ><a  href="#" onclick="assignment(this)" id="">全部贷前订单</a> <span class="badge" id="loanordercountdisplay">0</span></li>
        </ul>
      </div>
    </div>
    <div class="col-sm-12 row">
      <div class="col-sm-2">
        <ul>
          <li> <a href="#" onclick="assignment(this)" id="vehicleAssess">评估</a> <span class="badge" id="vehicleAssessdisplay">0</span> </li>
          <li> <a href="#" onclick="assignment(this)" id="judgment">终审</a> <span class="badge" id="judgmentdisplay">0</span> </li>
        </ul>
      </div>
      <div class="col-sm-2">
        <ul>
          <li> <a href="#" onclick="assignment(this)" id="departLeadAduit">初审</a> <span class="badge" id="departLeadAduitdisplay">0</span> </li>
          <li><a href="#" onclick="assignment(this)" id="signContract">签合同</a> <span class="badge" id="signContractdisplay">0</span></li>
        </ul>
      </div>
      <div class="col-sm-2">
        <ul>
          <li><a href="#" onclick="assignment(this)" id="trialPhase" >面审</a> <span class="badge" id="trialPhasedisplay">0</span></li>
          <li> <a href="#" onclick="assignment(this)" id="mortgage">办理抵押</a> <span class="badge" id="mortgagedisplay">0</span></li>
        </ul>
      </div>
      <div class="col-sm-2">
        <ul>
          <li><a href="#" onclick="assignment(this)" id="callBack">电话核实</a> <span class="badge" id="callBackdisplay">0</span></li>
          <li><a href="#" onclick="assignment(this)" id="instock">办理入库</a> <span class="badge" id="instockdisplay">0</span></li>
        </ul>
      </div>
      <div class="col-sm-2">
        <ul>
          <li> <a href="#" onclick="assignment(this)" id="visiteCheck">家访</a> <span class="badge" id="visiteCheckdisplay">0</span> </li>
          <li> <a href="#" onclick="assignment(this)" id="dataReview">复核</a> <span class="badge" id="dataReviewdisplay">0</span></li>
        </ul>
      </div>
    </div>
     <div class="col-sm-12 row" id="headHref">
      <div class="col-sm-2" id="headlended">
        <ul>
          <li> <a href="#" onclick="assignment(this)" id="lended">出账</a> <span class="badge" id="lendeddisplay">0</span> </li>
        </ul>
      </div>
    </div>
		</div>
		...
		<ol class="ui-step ui-step-red ui-step-10">
			<li class="step-start step-done">
				...
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">1</span>0<span
			...
			<li class="step-done">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">2</span>0<span
			...
			<li class="step-done">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">3</span>0<span
			...
			<li class="step-done">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">4</span>0<span
			...
			<li class="step-done">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">5</span>0<span
			...
			<li class="step-done">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">6</span>0<span
			...
			<li class="step-active">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">7</span>0<span
			...
			<li class="">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">9</span>0<span
			...
			<li class="step-end">
				<div class="ui-step-line"></div>
				<div class="ui-step-cont">
					<span class="ui-step-cont-number">10</span>0<span
    ...
    $(function () {
        ...
        $("#pledgeType").find('option[value="' + currentpledgeType + '"]').attr("selected", true);
			...
			if("y" == isReloanAndHeloanDis){
				...
				headHref += "<li> <a href='#' onclick='assignment(this)' id='reloanAduit'>再贷初审</a> <span class='badge' id='reloanReviewdisplay'>0</span> </li>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='helploanAduit'>助贷初审</a> <span class='badge' id='helploanAduitdisplay'>0</span> </li>";
				headHref += "</ul></div>";
				headHref += "<div class='col-sm-2'><ul>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='reloanReview'>再贷资料复核</a> <span class='badge' id='reloanAduitdisplay'>0</span> </li>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='helploanReview'>助贷资料复核</a> <span class='badge' id='helploanReviewdisplay'>0</span> </li>";
				headHref += "</ul></div>";
				headHref += "<div class='col-sm-2'><ul>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='reloanApprove'>再贷审批</a> <span class='badge' id='reloanApprovedisplay'>0</span> </li>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='helploanApprove'>助贷审批</a> <span class='badge' id='helploanApprovedisplay'>0</span> </li>";
				headHref += "</ul></div>";
				headHref += "<div class='col-sm-2'><ul>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='reloanE_Contract'>再贷电子合同签订</a> <span class='badge' id='reloanE_Contractdisplay'>0</span> </li>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='helploanE_Contract'>助贷电子合同签订</a> <span class='badge' id='helploanE_Contractdisplay'>0</span> </li>";
				headHref += "</ul></div>";
				headHref += "<div class='col-sm-2'><ul>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='reloan_lended'>再贷放款</a> <span class='badge' id='reloan_lendeddisplay'>0</span> </li>";
				headHref += "<li> <a href='#' onclick='assignment(this)' id='helploan_lended'>助贷放款</a> <span class='badge' id='helploan_lendeddisplay'>0</span> </li>";
				headHref += "</ul></div>";
			...
			success:function(data){
				...
				$("#reloanReviewdisplay").html(data.reloanAduit);
				...
				$("#reloanAduitdisplay").html(data.reloanReview);
		...
		{ 
            ...
            if(data.assignee != null && data.assignee != ""){
            	if((loanStatus == "vehicleAssess")||
            		...
            		caozuo="<td><a href='#' onclick='setCustomerIdHidden2(this)' id="+data.uuid+">处理</a></td>"
            	}
            	else{
			...
			context = "<tr id="+data.uuid+":"+states+" onclick='setEditCustomer(this)'>"
					+ "<td>" +jiaji+ "<a id="+data.uuid+" onclick='setCustomerIdHiddenSubmit(this)' href='javascript:void(0);'>" + data.orderid + "</a>" + "</td>"
					+ "<td>" + isImportant
					+ "<a id="+data.uuid + " onclick='getlenderdetails(this)' href='javascript:void(0);'>"
					+ data.customer_name + "</a></td>"
					+ "<td name='loans'>" + loanStatusStr + "</td>"
					+ "<td>" + pledgeTypeStr + "</td>"
             ...
             success: function (data) {
                 ...
                 if (code) {
                     layer.msg("操作成功!", {icon: 1, time: 1000}, function () {
						 ...
						 var loanDetailsTemp = map.get(id);
						 if(loanDetailsTemp.loan_status=="reuploadInformatin"){
							$(obj).html("处理");
							$(obj).attr("href","#");
							$(obj).attr("onclick","setCustomerIdHidden2(this)");
							...
							//alert(loanDetailsTemp.loan_status);
                         return true;
                     });
                 } else {
                     {
