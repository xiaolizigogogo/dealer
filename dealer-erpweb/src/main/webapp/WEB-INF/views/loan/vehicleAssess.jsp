...
<form id="carForm" action="javascript:;">
    ...
    <div class="from_box">
        ...
        <dl class="dl-horizontal col-sm-4">
            ...
            <div class="input_group" style=" width:160px;">
                  <input type="text" class="form-control" style="width:100%;" name="mileaged" value="${loanInfo.guaranteeEvaluateInfo.mileaged}" maxlength="5"
        ...
        <dl class="dl-horizontal col-sm-4">
              ...
              <dd>
            <input type="text" class="form-control" name="vehicleIdentification" maxlength="17"
        ...
        <dl class="dl-horizontal col-sm-4">
              ...
              <dd>
            <input type="text" class="form-control" name="engineNo" maxlength="10"
		                                        onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"
    ...
    <div class="from_box">
       ...
       <div class="from_con clearfix">
        ...
        <dl class="dl-horizontal col-sm-12">
              ...
              <dd>
          <textarea name="evaluateConclusion" cols="100" rows="3"  maxlength="50"  
    ...
    <input type="hidden" class="form-control" name="loanId" value="${loanInfo.uuid}">
