		...
		<div class="clearfix">
			<form class="form-inline pull-left" role="form">
				<div class="form-group">
					<label class="sr-only" for="txt_name">合同编号</label> <input
...
<!-- 				</div> -->
              ...
              <input type="text" hidden="hidden" id="searchDate"
        		...
        		<li><p class="text-danger" id="dc_tip" style="display:none;">订单统计表已导出</p></li>
				</ul>
		</div>
	</div>
	...
	<div id="user_modal" class="modal  fade in " style="width: 800px; height: 480px;background: rgb(238, 238, 238);"></div>
...
<script type="text/javascript">
	...
	function onLoadDate(param) {
...

		{
          ...
          //还款方式追加
			...
			var caozuo;
			if(result == "y"){
				caozuo =  "<td><a id="+data.uuid+" href='javascript:void(0);' onclick='setCustomerIdHidden2(this)'>归属人</a> <a id="+data.uuid+" href='javascript:void(0);' onclick='deleteloanwithworkflow(this)'>删除</a> <a id="+data.uuid+" href='/admin/loan/downloadAttachmentZip?loanId="+data.uuid+"'>附件下载</a></td>";
			}
	...
	function setCustomerIdHidden2(obj){
		$("#customer_id_hidden").val($(obj).attr("id"));
		$("#user_modal").load("/admin/loan/loanOwnerModifiyDetail.html");
		opendiv("user_modal");
	}
