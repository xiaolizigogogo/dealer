...
<head>
    ...
    <title>卖钱翁金融网站后台管理--应付账单（佣金提成）</title>
</head>
...
<script language="javascript">
    ...
    function search() {
        ...
        var url = "${basePath}/admin/financeManager/findCommissionSumCount?startDate=" + chargedoffAt + "&endDate=" + chargedoffAtEnd;
...
<div class="main-con">
    ...
    <div class="table-area" id="con_one_1">
        ...
        <table border="0" cellspacing="0" cellpadding="0"
            ...
            <tr>
                <th colspan="2" align='center' valign="middle">卖钱翁佣金提成报表</th>
            </tr>
            <tr>
                <td align="center">业务人员佣金总提成合计：</td>
                <td align="center">${resultMap.sumCommissionCount}</td>
            </tr>
            <tr>
                <td align="center">分销业务员佣金总提成合计：</td>
                <td align="center">${resultMap.sumOpenIdCommission}</td>
            </tr>
            <tr>
                <td align="center">报表统计时间：</td>
                <td align="center">${resultMap.startDate}&nbsp;至 &nbsp;${resultMap.endDate}</td>
            </tr>
