		...
		{ 
            ...
            if(loanStatus == "lended"){
            	 ...
            	 if(data.assignee != null && data.assignee != ""){
            	 	edit = "<a href = 'javascript:void(0)'  onclick='setCustomerIdHidden(this)' id="+data.uuid+":"+data.orderid+":"+data.taskId+":"+data.activityId+">处理</a>";
            	 }else{
			...
			context = "<tr>" 
					+ "<td>" + jiaji + "<a id="+data.uuid+":"+data.orderid
