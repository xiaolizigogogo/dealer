                        ...
                        <div class="table-area" id="con_one_2">
                            <table border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <td align="center">${repaymentDetailSum.finFeeSum}</td>
                                    <td align="center">${repaymentDetailSum.gpsSum}</td>
                                    <td align="center">${repaymentDetailSum.manageFee}</td>
                                    <td align="center">${repaymentDetailSum.repayTotalSum}</td>
                                    <td align="center">${repaymentDetailSum.totalSumCount}</td>
                    ...
                    <div class="row">
                        <div>
                            ...
                            <button type="button" class="btn btn-01" name="submit1" id="submit1"
                                    onclick="javascript:badLoanApplication('badLoanApplication')">坏账归档
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    function badLoanApplication(flag) {
        ...
        layer.confirm(dialogMsg, {icon: 3, title: '提示'}, function () {
            ...
            $.ajax({
                type: 'POST',
                url: '${basePath}/admin/loan/completeBadLoanApplication',
                data: {
