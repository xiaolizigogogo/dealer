...
<script>
		function getValue() {
		    ...
		    $.ajax({
		        type: 'POST',
		        url: '${basePath}/admin/roleManage/asssignRoleUser',
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <ul class="list-inline">
        <c:if test="${! empty roleManage.inRole}">
           <c:forEach var="inRole" items="${roleManage.inRole}" varStatus="s1">
            <c:if test= "${inRole.isShow =='Y'}">
             <c:if test="${! empty inRole.roleId}">
                <li class="checkbox">
                    <label>
    ...
    <div class="col-sm-10">
      <ul class="list-inline">
      	<c:if test="${! empty roleManage.noRole}">
            <c:forEach var="noRole" items="${roleManage.noRole}" varStatus="s2">
             <c:if test= "${noRole.isShow =='Y'}">
             <c:if test="${! empty noRole.roleId}">
            	<li class="checkbox">
                    <label>
    ...
    <div class="form-group">
      <div class="col-sm-offset-2 col-sm-10">
        <button type="button" class="btn btn-default" onclick="window.location='/admin/user/userList.jsp'" style="width:100px;">返回</button>
