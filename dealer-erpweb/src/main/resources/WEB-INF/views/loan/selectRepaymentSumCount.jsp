...
<script language="javascript">
    ...
    function search() {
        ...
        var url = "${basePath}/admin/financeManager/selectRepaymentSumCount?startDate=" + chargedoffAt + "&endDate=" + chargedoffAtEnd;
...
<div class="main-con">
    ...
    <div class="table-area" id="con_one_1">
        ...
        <table border="0" cellspacing="0" cellpadding="0"
            ...
            <tr>
                <th colspan="2" align='center' valign="middle">卖钱翁车贷应收账单</th>
            </tr>

            <tr>
                <td align="center">应收本金总额：</td>
                <td align="center">${resultMap.repayCapitalsum}</td>
            </tr>
            <tr>
                <td align="center">应收利息总额：</td>
                <td align="center">${resultMap.repayInterestSum}</td>
            </tr>
            <tr>
                <td align="center">应收管理费总额：</td>
                <td align="center">${resultMap.manageFeeSum}</td>
            </tr>
            <tr>
                <td align="center">应收GPS费总额：</td>
                <td align="center">${resultMap.gpsCostSum}</td>
            </tr>
            <tr>
                <td align="center">应收逾期费总额：</td>
                <td align="center">${resultMap.overdueFeeSum}</td>
            </tr>
            <tr>
                <td align="center">应收查档费总额：</td>
                <td align="center">${resultMap.checkCostSum}</td>
            </tr>
            <tr>
                <td align="center">应收停车费总额：</td>
                <td align="center">${resultMap.parkCostSum}</td>
            </tr>
            <tr>
