...
<script type="text/javascript">
    ...
    function init() {
        ...
        if (("" != mobile && null != mobile) || ("" != companyId && null != companyId)
                || ("" != deptId && null != deptId) || ("" != currentReviewLoanStatus && null != currentReviewLoanStatus)
    ...
    function onLoadDate(param) {
        var writetablefn = function (data) {
            ...
            var linkUrl = "${basePath}/admin/loan/getLoanSupplementDetail/" + data.uuid + ".html";
