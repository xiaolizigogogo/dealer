    ...
    <div class="op_box_con clearfix">
      <form class="form-horizontal">
        <div class="form-group">
      	...
      	<div class="form-group advance_info" style="display:none;">
              ...
              <input type="text" class="form-control" autofocus id=""
                     ...
                     onpaste="return false" style="width:100%;" value="0" name="refundFee" id ="refundFee" readonly="readonly"/>
  	  	...
  	  	<div class="form-group advance_info" style="display:none;" >
              ...
              <input type="text" class="form-control" autofocus id=""
                     ...
                     onpaste="return false" style="width:100%;" value="0" name="refundService"/>
              <span class="add-on input-group-addon">元</span> 
             </div>
  	 	    </div>
              ...
              <input type="text" class="form-control" autofocus id=""
                     ...
                     onpaste="return false" style="width:100%;" value="0" name="refundRate"/>
              <span class="add-on input-group-addon">元</span> </div>
  	 	    </div>
  	  	...
  	  	<div class="form-group advance_info" style="display:none;" >
              ...
              <input type="text" class="form-control" autofocus id=""
                     ...
                     onpaste="return false" style="width:100%;" value="0" name="refundManage"/>
              <span class="add-on input-group-addon">元</span> 
              </div>
  	 	    </div>
              ...
              <input type="text" class="form-control" autofocus id=""
                     ...
                     onpaste="return false" style="width:100%;" value="0" name="refundGps"/>
              <span class="add-on input-group-addon">元</span> 
              </div>
  	 	    </div>
  	  	...
  	  	<div class="form-group advance_info" style="display:none;" >
              ...
              <input type="text" class="form-control" autofocus id=""
                     ...
                     onpaste="return false" style="width:100%;" value="0" name="refundPark"/>
              <span class="add-on input-group-addon">元</span> 
              </div>
  	 	    </div>
              ...
              <input type="text" class="form-control" autofocus id=""
                     ...
                     onpaste="return false" style="width:100%;" value="0" name="refundRisk"/>
              <span class="add-on input-group-addon">元</span> 
              </div>
  	 	    </div>
        ...
        <div class="form-group advance_info" style="display:none;" id="penalty_revmoney_div">
          ...
          <div class="col-sm-3">
            <div class="input-group input-append pull-left" style="width:160px">
              ...
              maxlength="9" value="0" name="refundUrgent"/>
              <span class="add-on input-group-addon">元</span> </div>
          </div>
        </div>
        ...
        <div class="form-group advance_info" style="display:none;" id="overdue_revmoney"> 
          ...
          <div class="col-sm-3">
            <div class="input-group input-append pull-left" style="width:160px">
              ...
              maxlength="9" value="0" name="refundOverdueFee"/>
              <span class="add-on input-group-addon">元</span> 
            </div>
          </div>
        ...
        <div class="form-group advance_info" style="display:none;">
          ...
          <div class="col-sm-3">
            <div class="input-group input-append pull-left" style="width:160px">
              <input type="text" class="form-control" value="0" name="advanceRefundFee" readonly="readonly"/>
              <span class="add-on input-group-addon">元</span>
            </div>
          </div>                      
        </div> 
...
//		$("#order_modal").empty();
  ...
  $("#btnGenRepayPlan").click(function(){
    ...
    var uuid = $("#customer_id_hidden").val();
