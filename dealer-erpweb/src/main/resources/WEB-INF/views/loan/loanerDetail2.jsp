...
<div class="modal-body">
	<ol class="ui-step ui-step-red ui-step-10" id="ol_vehiclesLoans">
		...
		<li class="">
			...
			<div class="ui-step-cont">
				<span class="ui-step-cont-number" id="li_callBack">5</span> <span
					class="ui-step-cont-text">回访</span>
			</div>
		</li>
		<li class="">
			<div class="ui-step-line"></div>
			<div class="ui-step-cont">
				<span class="ui-step-cont-number" id="li_signContract">6</span> <span
		...
		<li class="">
			<div class="ui-step-line"></div>
			<div class="ui-step-cont">
				<span class="ui-step-cont-number" id="li_visiteCheck">7</span> <span
		...
		<li class="">
			<div class="ui-step-line"></div>
			<div class="ui-step-cont">
				<span class="ui-step-cont-number" id="li_judgment">8</span> <span
		...
		<li class="">
			<div class="ui-step-line"></div>
			<div class="ui-step-cont">
				<span class="ui-step-cont-number" id="li_dataReview">9</span> <span
		...
		<li class="step-end">
			<div class="ui-step-line"></div>
			<div class="ui-step-cont">
				<span class="ui-step-cont-number" id="li_lended">10</span> <span
...
<%--   </c:if> --%>
  ...
  <div class="op_box"  id="op_box_callBack" style="display:none;">
    ...
    <div class="op_box_con clearfix">
      <form class="form-horizontal">
        <div class="form-group">
					<label for="conclusion_callBack" class="col-sm-2 control-label"><i class="text-danger">*</i> 回访记录</label>
          <div class="col-sm-8">
                    		...
                    		$.ajax({
    	                        ...
    	                        success:function(data){
    	                        	 layer.msg("操作成功!", {icon: 1, time: 1000}, function () {
			                             ...
			                             $("#fade1").hide();
    	                                 if(window.location.href.indexOf("agency")>0){
                        		 			document.location.href = '/admin/loan/agency.html';
                        				 }else if(window.location.href.indexOf("newtask")>0){
