                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <button type="button" class="btn btn-01" name="submit1" id="submit1"
                                    onclick="javascript:lateProcessing('noDispose')">暂不处理
                            </button>
                            &nbsp; &nbsp; &nbsp;
                            <button type="button" class="btn btn-01" name="submit3" id="submit3"
                                    onclick="javascript:lateProcessing('interestHandle')">申请罚息调整
                            </button>
                            &nbsp; &nbsp; &nbsp;
                            <button type="button" class="btn btn-01" name="submit3" id="submit4"
                                    onclick="javascript:lateProcessing('trackCarHandle')">拖车处理
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    function lateProcessing(flag) {
        ...
        layer.confirm(dialogMsg, {icon: 3, title: '提示'}, function () {
            ...
            $.ajax({
                type: 'POST',
                url: '${basePath}/admin/loan/completeLateProcessing',
                data: {
