    ...
    <script>
        ...
        $(function () {
            ...
            $("#buy_car_method").change(function(){
                ...
                showfees(repayway,buyway,plantype,pledgetype,applymoney);
            });
            //根据方案选择，进行默认系统参数的表示
...
//                        });
        ...
        function showfees(repayway,buyway,plantype,pledgetype,applymoney){
            debugger;
            //画面首次进入时，用户接口金额检查
            if(applymoney == ''){
                applymoney = 0;
            ...
            //②GPS流量费
            if(pledgetype == "drivePledge"){
                $("#drunkDrive_dl").css("display","block");
                ...
                $("#drunkDrive_dl").css("display","none");
                $("#drunkDrive").val("0");
            }
            //③办理费
            $("#gpsCost_div").css("display","block");
            if(pledgetype == "drivePledge"){
                //办理费
                $("#gpsCost").val(800);
            }else {
            ...
            }else if(repayway == "InterestRatesBefore"){             //等本等息的情况下
                //先息后本的情况下
                //服务费收取方式为按月收取
                if(plantype == 0){
                    //风险金
                    ...
                    if(pledgetype == "drivePledge"){
                        //压证的情况下;
                        if(applymoney < 10){
                            $("#monthly_rate").val(0.88);
                            $("#year_rate").val(accMul(0.88,12));
                            $("#depreciationFee").val(2);
                        }else{
                            //10万以上的部分
                            $("#monthly_rate").val(0.68);
                            $("#year_rate").val(accMul(0.68,12));
                            $("#depreciationFee").val(2);
                        }
        ...
        function setfees(periods,interest,depreciation){
            $("#monthly_rate").val(interest);
            $("#year_rate").val(accMul(interest,12));
            $("#depreciationFee").val(depreciation);
            $("#loanLimitTime").val(periods);
        }
    </script>
</head>
        ...
        <div class="tools_bar ">
            ...
            <div class="from_box">
                ...
                <div class="from_con clearfix">
                    ...
                    <dl class="dl-horizontal col-sm-4">
                        <dt><i class="text-danger">*</i> 抵押方式</dt>
                        <dd>
                    ...
                    <dl class="dl-horizontal col-sm-4">
                        ...
                        <dd>
                            <select class="form-control pull-left" id="plantype" name="plantype">
                                <option value="0"
                                        <c:if test="${loanInfo.plantype eq '0'}">selected</c:if>>综合服务费按月收取 </option>
                                <option value="1"
                                        <c:if test="${loanInfo.plantype eq '1'}">selected</c:if>>综合服务费一次性收取 </option>
                            </select>
                        </dd>
                    </dl>
                </div>
            ...
            <div class="from_box">
                ...
                <div class="from_con clearfix">
                    ...
                    <dl class="dl-horizontal col-sm-3" id="drunkDrive_dl">
                        <dt><i class="text-danger">*</i> GPS每月流量费</dt>
                        <dd>
                            <div class="input_group" style="max-width:120px">
                                <input type="text" class="form-control" id="drunkDrive" name="drunkDrive" style="width:100%;" value="0" >
                                <span class="danwei">元</span> </div>
                        </dd>
                    </dl>
                    <dl class="dl-horizontal col-sm-3" id="cashdepositFee_dl" >
                        <dt><i class="text-danger">*</i> 风险保证金</dt>
                        <dd>
                            <div class="input_group" style="max-width:120px">
                    ...
                    <dl class="dl-horizontal col-sm-3">
                        <dt><i class="text-danger">*</i> 综合服务费</dt>
                        <dd class="clearfix">
                            <div class="input_group pull-left " style="max-width:120px">
                                ...
                                <span class="danwei">% </span> </div><span class="pull-left" style=" padding-left:5px; line-height:30px;">/ 月</span>
                        </dd>
                    </dl>
                    <dl class="dl-horizontal col-sm-3" id="gpsCost_div">
                        <dt>办理费</dt>
                        <dd>
                            <div class="input-group" style="width:120px;">
                                <input type="text" class="form-control" id="gpsCost" name="gpsCost" style="width:100%;" value="100" maxlength="4" >
                            </div>
                        </dd>
                    </dl>
                ...
                <div class="from_con clearfix">
                    ...
                    <dl class="dl-horizontal col-sm-3" id="gps" style="display:none;">
                        <dt>GPS流量费</dt>
                        <dd>
                            <select class="form-control" id="gpsWay" name="gpsPattern" value="GPS_MONTH_COST">
                                <option value="GPS_YEAR_COST">按年收取</option>
                                <option value="GPS_MONTH_COST">按月收取</option>
                            </select>
                        </dd>
                    </dl>
                </div>
            ...
            <div class="from_box">
                ...
                <div class="from_con clearfix">
                    ...
                    <dl class="dl-horizontal col-sm-3">
                        <dt> 开户人身份证号</dt>
                        <dd>
                            <input type="text" class="form-control" id="accountIdnum"  maxlength="18"
                            	   onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"
                                   name="accountIdnum" value="${accountInfo.accountIdnum}">
                        </dd>
                    </dl>
                    <dl class="dl-horizontal col-sm-3">
                        <dt>开户行</dt>
                        <dd>
                            <input type="text" class="form-control" id="bankName"  maxlength="60"
...
//                     getUsers('${loanInfo.companyId}', '${loanInfo.deptId}');
        ...
        //金额变更之后
        $("#applyMoney").live("change",function(){
            var buyway = $("#buy_car_method").val();
            var plantype = $("#plantype").val();
            var pledgetype = $("#pledgeType").val();
            var repayway = $("#repayWay").val();
        ...
        $("#pledgeType").live("change", function () {
            ...
            if (pledgeType === 'vehiclePledge') {
                ...
                var html = '<option value="GPS_YEAR_COST">按年收取</option>';
                $("#gpsWay").html(html);
                var buyway = $("#buy_car_method").val();
                var plantype = $("#plantype").val();
                var pledgetype = $("#pledgeType").val();
                ...
                var html = '<option value="GPS_YEAR_COST">按年收取</option>';
                html += '<option value="GPS_MONTH_COST">按月收取</option>';
                $("#gpsWay").html(html);
                var buyway = $("#buy_car_method").val();
                var plantype = $("#plantype").val();
                var pledgetype = $("#pledgeType").val();
        ...
        var getGenerateLoanReplayPlan = function () {
            ...
            var drunkDrive = $("#drunkDrive").val();//GPS流量费
            ...
            var gpsCost = $("#gpsCost").val();//按月收取的gps费用
            //如果是等额本金和先息后本
