...
<script type="text/javascript">
         ...
         $.ajax({
			url:"${basePath}/admin/loan/queryloancount",
			type:"get",
			datatype:"json",
			success:function(data){
			var a=data.loancount;
			
           var dataSet = anychart.data.set([
    ['01月', a[0]/10000, 16, 20, 33],
    ['02月', a[1]/10000, 20, 25, 30],
    ['03月', a[2]/10000, 21, 28, 31],
	 ['04月', a[3]/10000, 18, 27, 28],
	  ['05月', a[4]/10000, 19, 25, 39],
	   ['06月', a[5]/10000, 24, 25, 21],
	    ['07月', a[6]/10000, 20, 37, 30],
		 ['08月', a[7]/10000, 16, 35, 22],
		  ['09月', a[8]/10000, 17, 35, 35],
		   ['10月', a[9]/10000, 30, 33, 40],
		    ['11月', a[10]/10000, 15, 27, 33],
			 ['12月', a[11]/10000, 26, 28, 32]
  ]);
...
return this.seriesName + '\n 销售总额：￥ ' + this.value +'万元';
 ...
 chart.listen("pointClick", function(e){
  ...
  var month = row[0];
  window.location = "/admin/loan/InfoList.html?date="+month.substring(0, 2) ;
});
