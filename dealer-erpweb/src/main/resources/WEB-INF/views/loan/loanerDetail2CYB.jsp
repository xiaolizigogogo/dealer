...
<div class="modal-body">
  ...
  <ol class="ui-step ui-step-red ui-step-16" id="ol_vehiclesLoans_group" style="display:none;">
    <li class="step-start step-done">
      <div class="ui-step-line"></div>
      <div class="ui-step-cont">
    ...
    <li class="">
      <div class="ui-step-line"></div>
      <div class="ui-step-cont">
        <span class="ui-step-cont-number" id="ligroup_reloanAduit">12</span> <span
              class="ui-step-cont-text" id="reloanAduit_span">再贷初审</span>
      </div>
    </li>
    <li class="">
      <div class="ui-step-line"></div>
      <div class="ui-step-cont">
        <span class="ui-step-cont-number" id="ligroup_reloanReview">13</span> <span
          class="ui-step-cont-text" id="loanReview_span">再贷资料<br>复核</span>
      </div>
    </li>
    <li class="">
      <div class="ui-step-line"></div>
      <div class="ui-step-cont">
        <span class="ui-step-cont-number" id="ligroup_reloanApprove">14</span> <span
          class="ui-step-cont-text" id="laonApprove_span">再贷审批</span>
      </div>
    </li>
    <li class="">
      <div class="ui-step-line"></div>
      <div class="ui-step-cont">
        <span class="ui-step-cont-number" id="ligroup_reloanE_Contract">15</span> <span
    ...
    <li class="step-end">
      <div class="ui-step-line"></div>
      <div class="ui-step-cont">
        <span class="ui-step-cont-number" id="ligroup_reloan_lended">16</span> <span
          class="ui-step-cont-text" id="loan_lended_span">再贷放款</span>
      </div>
    </li>
  </ol>
  <div class="tab_box">
...
<%--   </c:if> --%>
    ...
    <div class="op_box" id="op_box_trialPhase" style="display:none;">
        ...
        <div class="op_box_con clearfix">
            <form class="form-horizontal" id="">
                <div class=" col-sm-8">
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><i class="text-danger">*</i> 审评结论</label>
                        <div class="col-sm-8">
                            <label class="radio-inline">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-3 control-label"><i class="text-danger">*</i> 审批金额</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label  class="col-sm-3 control-label"><i class="text-danger">*</i> 意见</label>
                        <div class="col-sm-8">
          ...
          <div class="col-sm-3">
            <div class="input_group" style="max-width: 120px">
              <input type="text" name="period_helploan" maxlength="5"
                     style="width: 120px;" id="period_helploan" value="0"
          ...
          <div class="col-sm-3">
            <div class="input_group" style="max-width: 120px">
              <input type="text" class="form-control" name="serviceMoney"
                     ...
                     onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''"
                     onpaste="return false" maxlength="5" value="0.00"
                     style="width: 100%;"> <span class="danwei">元</span>
            </div>
          </div>
          <label class="col-sm-2 control-label"><i
              class="text-danger">*</i> 其它费用</label>
          <div class="col-sm-3">
            <div class="input_group" style="max-width: 120px">
  ...
  <div class="op_box"  id="op_box_reloanAduit" style="display: none;">
    <h4>再贷初审</h4>
    <div class="op_box_con clearfix">
      <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <label class="radio-inline">
              <input type="radio" name="reviewStatus_reloanAduit" id="reloanAduitinlineRadio1" value="passed" checked="checked">
              通过 </label>
            <label class="radio-inline">
              <input type="radio" name="reviewStatus_reloanAduit" id="reloanAduitinlineRadio2" value="rejected">
              放弃 </label>
          </div>
        </div>
        <div class="form-group">
          <label  class="col-sm-2 control-label"><i class="text-danger">*</i> 意见</label>
          <div class="col-sm-8">
            <textarea cols="168" rows="2" class="form-control" id="conclusion_reloanAduit" maxlength="50"
                      name="conclusion"></textarea>
          </div>
        </div>
      </form>
  ...
  <div class="op_box"  id="op_box_helploanAduit" style="display: none;">
    <h4>助贷初审</h4>
    <div class="op_box_con clearfix">
      <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <label class="radio-inline">
              <input type="radio" name="reviewStatus_helploanAduit" id="helploanAduitinlineRadio1" value="passed" checked="checked">
              通过 </label>
            <label class="radio-inline">
              <input type="radio" name="reviewStatus_helploanAduit" id="helploanAduitinlineRadio2" value="rejected">
              放弃 </label>
          </div>
        </div>
        <div class="form-group">
          <label  class="col-sm-2 control-label"><i class="text-danger">*</i> 意见</label>
          <div class="col-sm-8">
            <textarea cols="168" rows="2" class="form-control" id="conclusion_helploanAduit" maxlength="50"
                      name="conclusion"></textarea>
          </div>
        </div>
      </form>
  ...
  <div class="op_box"  id="op_box_reloanReview" style="display: none;">
          ...
          <div class="col-sm-3">
            <div class="input_group" style="max-width: 120px">
              <input type="text" name="loanLimitTime" maxlength="5"
                     style="width: 120px;" id="period_reloan" value="0"
                     class="form-control valid"> <span class="danwei">月</span>
            </div>
          </div>
          <label class="col-sm-2 control-label"><i
    ...
    <div class="op_box_con clearfix">
      <form class="form-horizontal">
        <div class=" col-sm-8">
          <div class="form-group" >
            <label class="col-sm-3 control-label"><i class="text-danger">*</i> 出账时间</label>
            <div class="col-sm-8">
              <div class="input-group date form_date" data-date=""
                 data-date-format="yyyy-mm-dd"
  ...
  <div class="op_box"  id="op_box_lended" style="display: none;">
    ...
    <div class="op_box_con clearfix">
      <form class="form-horizontal">
        <div class="form-group">
          <div class="col-sm-6">
            <label class="col-sm-4 control-label"><i class="text-danger">*</i> 出账方式选择</label>
            <label class="radio-inline">
          ...
          <div class="form-group">
            <div class="col-sm-4">
              ...
              <div class="input-group date form_date" data-date=""
                             data-date-format="yyyy-mm-dd"
                             data-link-field="lendDate_acb"
                             data-link-format="yyyy-mm-dd" style="width:200px;">
                <input class="form-control" type="text" value="" readonly style="width:100%;" />
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
              </div>
              <input type="text" hidden="hidden" id="lendDate_acb" name="lendDate_acb"/>
            </div>
          </div>
        <c:if test="${compatible_display eq 'y'}">
          <div class="form-group">
            <div class="col-sm-6">
              <label class="col-sm-4 control-label"><i class="text-danger">*</i> 总公司放款年化利率</label>
              <div class="col-sm-5">
                <div class="input_group" style="max-width:120px">
                  <input type="text" id="loanacb_rate" maxlength="8" style="width:100%;" name="loanacb_rate" class="form-control"
                         onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''"
                         onpaste="return false" />
                  <span class="danwei">%</span>
                </div>
            ...
            <div class="col-sm-3">
              <label class="col-sm-4 control-label"><i class="text-danger">*</i> 借款期限</label>
              <div class="col-sm-5">
                <div class="input_group" style="max-width: 120px">
                  <input type="text" name="loanLimitTime" maxlength="5"
                         style="width: 120px;" id="loanacb_period" value=""
                         class="form-control valid" /> <span class="danwei">月</span>
                </div>
              </div>
            </div>
          ...
          <div class="form-group">
            <div class="col-sm-6">
              <label class="col-sm-4 control-label"><i class="text-danger">*</i> 还款方式</label>
              <div class="col-sm-4">
                <select class="form-control pull-left valid" id="loandirect_repayWay" name="repayWay">
                  <option value="InterestRatesBefore"> 先息后本</option>
                </select>
              </div>
            </div>
            <div class="col-sm-4">
              <label class="col-sm-3 control-label"><i class="text-danger">*</i> 服务费</label>
                <div class="col-sm-8">
                  <div class="input_group" style="max-width: 120px">
                    <input type="text" class="form-control" name="serviceFee" id="loanacb_serviceFee"
                           onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''"
                           onpaste="return false" maxlength="5" value="" style="width: 100%;"> <span class="danwei">元</span>
                  </div>
                </div>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-6">
              <label class="col-sm-4 control-label"><i class="text-danger">*</i> 其他费用</label>
                <div class="col-sm-3">
                  <div class="input_group" style="max-width: 120px">
                    <input type="text" class="form-control" name="loanacb_otherFee"
                           id="loanacb_otherFee"
                           onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''"
                           onpaste="return false" maxlength="5" value="" style="width: 100%;"> <span class="danwei">元</span>
                  </div>
            ...
            <label class="col-sm-1 control-label"><i class="text-danger">*</i> 开始时间</label>
            <div class="col-sm-3">
              <div class="input-group date form_date" data-date=""
                   data-date-format="yyyy-mm-dd"
                   data-link-field="loanacb_startDate"
                   data-link-format="yyyy-mm-dd" style="width:200px;">
                <input class="form-control" type="text" value="" readonly style="width:100%;" />
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
              </div>
              <input type="text" hidden="hidden" id="loanacb_startDate" name="loanacb_startDate"/>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-6">
              <label class="col-sm-4 control-label"><i class="text-danger">*</i> 是否推送数据到平台</label>
              <div class="col-sm-3">
                <label class="radio-inline">
                  <input type="radio" name="datePushSelect" id="nopush" value="nopush" checked="checked"/>
                  不推送 </label>
                <label class="radio-inline">
                  <input type="radio" name="datePushSelect" id="push" value="push"/>
                  推送 </label>
              </div>
            </div>
            <div class="col-sm-4" id="pushRadio">
              <label class="col-sm-3 control-label"><i class="text-danger">*</i> 平台标识</label>
              <div class="col-sm-3">
                <select class = "form-control" style="width:160px;" id="datePushRadioACB" name="PushRadioACB">
                  <option value="0" selected="selected">icb</option>
                </select>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="col-sm-5">
              ...
              <div class="col-sm-8">
                <a href="#plan-list" class="btn btn-success btn-search plan-show"
                   onclick="generateRepayPlanB2B('loandirect_acb')">生成还款计划</a>
              </div></div>
          </div>
          <div class="list_box">
            <table class="table table-bordered table-striped">
...
<input type="hidden" id="datePush" value="success"/>
...
<script type="text/javascript">
  ...
  function doReview(conclusion,loanId,reviewStatus,processDefinitionId,taskId,reviewMoney,lendDate){
	  debugger;
    if($("input[name='datePushSelect']:checked").val() == 'push'){
        $.ajax({
          type: 'POST',
          url: '${basePath}/admin/loan/queryLoanerInformation.html',
          beforeSend: function () {
	            load = layer.load();
          },
          data: {
            "order_num": orderid,
            "icb": $("select[name=PushRadioACB] option[selected]").text()
          },
          dataType:"json",
          async: false,
          success:function(data){
        	  if(data.status_code == '202'){
                  $("#datePush").val("fail");
                  layer.close(load);
                  layer.msg("推送数据到平台错误,错误原因：重复订单!");
                  return false;
                }else if(data.status_code == '303'){
                  $("#datePush").val("fail");
                  layer.close(load);
                  layer.msg("推送数据到平台错误,错误原因：签名信息有误!");
                  return false;
                }else if(data.status_code == '406'){
                  $("#datePush").val("fail");
                  layer.close(load);
                  layer.msg("推送数据到平台错误,错误原因：存在必填字段空!");
                  return false;
                }else if(data.status_code == '412'){
                  $("#datePush").val("fail");
                  layer.close(load);
                  layer.msg("推送数据到平台错误,错误原因：存在无法通过验证的数据!");
                  return false;
                }else if(data.status_code == '101'){
                  $("#datePush").val("fail");
                  layer.close(load);
                  layer.msg("推送数据到平台错误,错误原因：订单信息不存在!");
                  return false;
                }
          }, error: function () {
            $("#datePush").val("fail");
    ...
    if( $("#datePush").val() == "success" || $("input[name='datePushSelect']:checked").val() == 'nopush'){
      $.ajax({
        type: 'POST',
       ...
       success: function (data) {
         if (data == '0000') {
           if(((processDefinitionId == "lended")&&(reviewStatus == 'loandirect'))||
                   ...
                   ((processDefinitionId == "helploanAduit")&&(reviewStatus == "rejected"))){
             $.ajax({
              type: "POST",
              ...
              success:function(data){
                layer.msg("操作成功!", {icon: 1, time: 1000}, function () {
	              ...
	              $("#fade1").hide();
                  loanBeforeSingleHelper();
                  return true;
                });
              }
            });
          } 
           else if((processDefinitionId == 'reloanReview')&&(reviewStatus == "passed")){
            $.ajax({
              type: 'POST',
            ...
            }else if((processDefinitionId == 'helploanApprove')&&(reviewStatus == "passed")){
              $.ajax({
                type: 'POST',
                url: '${basePath}/admin/loan/savereloaninfo.html',
                data: {
           ...
           layer.msg("目前公司的授信额度即将达到上限，请与总公司协商调整授信额度");
           return false;
         } else {
...
//        window.open(url, '_blank');
  ...
  /** 提交评审 */
    function submitReview() {
      ...
      if((lendedMethod == 'loandirect')||(lendedMethod == 'helploan')||(lendedMethod == 'loandirect_acb')){
     ...
     //    }
      ...
      if (reviewStatus == "loandirect") {
        ...
        (processDefinitionId === 'helploanReview')||
                (processDefinitionId === 'reloanAduit')||
                (processDefinitionId === 'helploanAduit')){
      if (reviewStatus == "rejected") {
        reviewStatusStr = "放弃";
      }else{
        reviewStatusStr = "通过";
      ...
      //对比填项目进行check
      if(reviewStatus != "rejected"){
        if (processDefinitionId === 'reloanReview'){
          if($("#reloan_rate").val() == ''){
            layer.msg("再贷年化利率不能为空，请确认!");
            return false;
          }
          if($("#period_reloan").val() == ''){
        	 layer.msg("借款期限不能为空，请确认!");
             return false;
          }
          if($("#serviceFee_reloan").val() == ''){
         	 layer.msg("服务费不能为空，请确认!");
              return false;
           }
          if($("#otherFee_reloan").val() == ''){
         	 layer.msg("其它费用不能为空，请确认!");
              return false;
           }
          ...
          if($("#helploan_rate").val() == ''){
            layer.msg("助贷年化利率不能为空，请确认!");
            return false;
          }
          if($("#period_helploan").val() == ''){
         	 layer.msg("借款期限不能为空，请确认!");
              return false;
           }
           if($("#serviceFee_helploan").val() == ''){
          	 layer.msg("服务费不能为空，请确认!");
               return false;
            }
           if($("#otherFee_helploan").val() == ''){
          	 layer.msg("其它费用不能为空，请确认!");
               return false;
            }
...
//      var taskId = $("#taskId").val();
        var reviewMoney = 0.00;
        if(processDefinitionId == "trialPhase"){
            reviewMoney = $("#reviewMoney").val() * 10000;
  ...
  <c:if test="${compatible_display eq 'y'}">
    if(lendedMethod == 'loandirect_acb') {
 ...
 $(".collection_link").click(function(){
  $(this).parents("tr").siblings().not(".parent").not(":first-child").hide();
  $(this).parents("tr").next().find($(".cuishou_box")).show();
  $(this).parents("tr").next().find($(".huankuan_box")).hide();
  $(this).parents("tr").next().show().next().show();
 });
 $(".collection_money").click(function(){
   $(this).parents("tr").siblings().not(".parent").not(":first-child").hide();
  $(this).parents("tr").next().find($(".cuishou_box")).hide();
  $(this).parents("tr").next().find($(".huankuan_box")).show();
  $(this).parents("tr").next().show().next().show();
   });
...
//    }
    ...
    $("#up_img_WU_FILE_23").fileupload({
      dataType: 'json',
        ...
        $("#up_img_WU_FILE_24").fileupload({
            dataType: 'json',
            done: function (e, data) {
                doneProcess(data,$('#imgShow_WU_FILE_24'));
            }
        });
  ...
  //var loan_uuid = $("#customer_id_hidden").val().split(":")[0];
	var loan_uuid = loanDetailsAll.uuid;
  ...
  new uploadPreview({ UpBtn: "up_img_WU_FILE_"+n, ImgShow: "imgShow_WU_FILE_"+n});  
    ...
    var uuid;
	  var ldaStatus = loanDetailsAll.loan_status;
      ...
      success : function(data) {
        ...
        for(var i=0; i< length; i++){
          ...
          if(record.loanStatus == "vehicleAssess"){
            ...
            loanstatus = "待助贷初审";
          }else if(record.loanStatus == "reloanAduit_rejected"){
          	loanstatus = "再贷初审放弃";  
          }
          var str = "<tr>"
    ...
    $.ajax({
      ...
      success : function(data) {
        ...
        $("#gpsCost").html((data.loanInfo.gpsCost==""?"0":data.loanInfo.gpsCost)+"元");
        //设置状态进度条
                var processDefinitionId = $("#processDefinitionId").val();
...
//            alert(data.customerRegisterInfo.remark)
          ...
          success : function(data) {
            ...
            for(var q=0;q<data.loanInfoAttachmentssize;q++){
              ...
              if(type=="oneCarPhoto"||type=="vehiclStatusOne"||type=="vehicleLicense"||type=="registrationCertificateOne"||type=="businessInsurancePolicy"||type=="vehiclStatusThree"||type=="vehiclStatusFour"
                 ...
                 ||type=="pledgeVehicleConsultArchives"||type=="mortgageReview"){
               var ul='<li> <div class="file_img"> <p class="tools">'
                      +'<a href="javascript:void(0);" onclick="pictureDownload('+path.id+')" title="保存"><i class="fa  fa-save"></i></a>'
                      +'<a href="'+path.attachmentPath+'" data-lightbox="example-set" data-title="'+title+'" title="放大"><i class="fa  fa-search-plus"></i></a></p>'
                      +'<a href="'+path.attachmentPath+'" data-lightbox="set_img" data-title="'+title+'" title="放大"><img class="example-image" src="'+path.attachmentPath+'"  id="idCardType" /></a> </div>'
    ...
    //爱车帮数据推送，选择推送的情况下显示平台标识框
    $("input[name='datePushSelect']").change(function(){
      //推送的情况下，标识设置为可见状态
      if($("input[name='datePushSelect']:checked").val() == "push"){
        //$(".platform_identifier").css("display","block");
        $("#pushRadio").show();
        $("input[name='loanMethodSelect']").attr('checked','true');
      }else{
        //$(".platform_identifier").css("display","none");
        $("#pushRadio").hide();
        $("input[name='loanMethodSelect']").attr('checked','true');
      }
    });
    ...
    if(currentindex > 10){
      ...
      if(processDefinitionId.indexOf("help")>=0){
        processDefinitionId = processDefinitionId.replace(/help/,"re");
                //更换助贷文字
        $("#loanReview_span").html("助贷资\<br\>料复核");
        $("#laonApprove_span").html("助贷\<br\>审批");
        $("#contract_span").html("助贷电子\<br\>合同签订");
        $("#loan_lended_span").html("助贷\<br\>放款");
        $("#reloanAduit_span").html("助贷\<br\>初审");
      }
    }
  ...
  function generateRepayPlanB2B(type)
  {
    ...
    debugger;
    if("reloan" == type){
      loan_rate=$("#reloan_rate").val();
      startDate = $("#startDate_reloan").val();
      endDate = $("#endDate_reloan").val();
      period= $("#period_reloan").val();
      otherFee= $("#otherFee_reloan").val();
      serviceFee= $("#serviceFee_reloan").val();
      repayWay=$("#repayWay_reloan").val();
      conclusion = $("#conclusion_reloanReview").val();
    }else if("loandirect_acb" == type){
      loan_rate=$("#loanacb_rate").val();
      startDate = $("#loanacb_startDate").val();
      period= $("#loanacb_period").val();
      otherFee= $("#loanacb_otherFee").val();
      serviceFee= $("#loanacb_serviceFee").val();
      repayWay=$("#loandirect_repayWay").val();
      conclusion = $("#conclusion_lended").val();
    }else{
      loan_rate=$("#helploan_rate").val();
      startDate = $("#startDate_helploan").val();
      period= $("#period_helploan").val();
      otherFee= $("#otherFee_helploan").val();
      serviceFee= $("#serviceFee_helploan").val();
      repayWay=$("#repayWay_helploan").val();
      conclusion = $("#conclusion_helploanApprove").val();
    }
    ...
    $.ajax({
      url : "/admin/loanB2B/generateRepayPlanB2B_Reloan",
      type : "get",
      dataType : "json",
      data:{
        "loan_rate": loan_rate,
