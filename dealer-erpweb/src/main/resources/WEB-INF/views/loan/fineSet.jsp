...
<div id="dialog-confirm" title="更改罚息" style="display: none" >
    <p>
        <span> 罚息金额:<input name="finFee" id="finFee"  readonly= "true"></span>
        <br/>
        <span> 调整金额:<input name="updatefinFee" id="updatefinFee" type="text"></span>
        <span> <input name="repayPlanDetailId" id="repayPlanDetailId" type="hidden"></span>
    </p>
</div>
<div class="main-con">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <!---
                                          ...
                                          <a class="link-01" href="javascript:fineSetUpdate(${l.repayPlanDetailId})">调整罚息</a>

                                        -->


                                        <a class="link-01" href="javascript:fineSetUpdate('${l.overdueFee}','${l.repayPlanDetailId}')">调整罚息</a>
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <button type="button" class="btn btn-01" name="submit1" id="submit1"
                                    onclick="javascript:completeUpdatefinFee('fineSet')">完成罚息修改
                            </button>
                        </div>
                    </div>
                    </form>
...
<script>
    ...
    function fineSetUpdate(finFee,repayPlanDetailId) {
        $("#dialog-confirm").dialog("open");
        var finFee = finFee;
        var repayPlanDetailId = repayPlanDetailId;
        $("#finFee").val(finFee);
        $("#repayPlanDetailId").val(repayPlanDetailId);
    ...
    function completeUpdatefinFee(data) {
        ...
        layer.confirm(dialogMsg, {icon: 3, title: '提示'}, function () {
            ...
            $.ajax({
                type: 'POST',
                url: '${basePath}/admin/loan/completeUpdatefinFee',
                data: {
    ...
    function confirmFinFeeUpdate() {
        ...
        if(isNaN(finFee)){
            layer.msg("请输入正确的调整金额");
            return;
        }

            $.ajax({
                type: 'POST',
                url: '${basePath}/admin/loan/updateFinFee',
                data: {
                    "finFee": finFee,
