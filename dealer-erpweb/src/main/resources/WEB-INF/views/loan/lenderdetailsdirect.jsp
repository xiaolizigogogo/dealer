...
<%
	String latent = request.getParameter("uuid");
%>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<body>
<input type="hidden" value=${param.uuid} id="custom_id"/>
<div class="modal-header"> <a  type="button" href = "javascript:void(0)" onclick = "javascript:history.back()"  class="close" ><span aria-hidden="true">&times;</span></a>
...
<div class="modal-footer">
  <p class="col-sm-2"> <a  href = "javascript:void(0)" onclick = "transition()" class="btn btn-default btn-block">返回列表</a> </p>
</div>
...
<script type="text/javascript" src="${basePath}/js/loanerDetaildirect.js"></script>
</html>
