                        ...
                        <div class="table-area" id="con_one_2">
                            <table border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    ...
                                    <th>购买车辆全险</th>
                                    <th>暗锁</th>
                                    <c:if test="${! empty loanInfo.guaranteeEvaluateInfo.darkLocksPosition}">
                                        <th>暗锁位置</th>
                                    </c:if>
                                    <th>购买方式</th>
                                    <th>评估价格</th>
                                    <c:if test="${! empty loanInfo.guaranteeEvaluateInfo.evaluateConclusion}">
                                        <th>评估结果</th>
                                    </c:if>
                                    <th>拖车状态</th>
                                    <th>人车合照</th>
                                ...
                                <tr>
                                    ...
                                    <td align="center">${loanInfo.guaranteeEvaluateInfo.isExamined}</td>
                                    <td align="center">${loanInfo.guaranteeEvaluateInfo.isInsure}</td>
                                    <td align="center">${loanInfo.guaranteeEvaluateInfo.darkLocks}</td>
                                    <c:if test="${! empty loanInfo.guaranteeEvaluateInfo.darkLocksPosition}">
                                        <td align="center">${loanInfo.guaranteeEvaluateInfo.darkLocksPosition}</td>
                                    </c:if>
                                    <td align="center">${loanInfo.guaranteeEvaluateInfo.buyTheWay}</td>
                                    <td align="center">${loanInfo.guaranteeEvaluateInfo.evaluatePrice}</td>

                                    <c:if test="${! empty loanInfo.guaranteeEvaluateInfo.evaluateConclusion}">
                                        <td align="center">${loanInfo.guaranteeEvaluateInfo.evaluateConclusion}</td>
                                    </c:if>
                                    ...
                                    <c:if test="${loanInfo.guaranteeEvaluateInfo.towStatus == 'waitTruck'}">
                                        <td align="center">待拖车</td>
                                    </c:if>
                                    <td align="center">
                                        <a href="${attachmentPath}"
                                           target="_blank" class="link-01">查看</a>
                                    </td>
                                </tr>
                    ...
                    <div class="main-con">
                        <div class="table-area" id="con_one_5">
                            <table border="0" cellspacing="0" cellpadding="0"
                                ...
                                <c:forEach items="${signContractReviewList}" var="l">
                                    <tr>
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <button type="button" class="btn btn-01" name="submit1" id="submit1"
                                    onclick="javascript:detainCar('alreadyTowTruck')">已拖车
                            </button>
                            &nbsp; &nbsp; &nbsp;
                            <button type="button" class="btn btn-01" name="submit3" id="submit3"
                                    onclick="javascript:detainCar('noTowTruck')">未拖车
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    function detainCar(flag) {
        ...
        layer.confirm(dialogMsg, {icon: 3, title: '提示'}, function () {
            ...
            $.ajax({
                type: 'POST',
                url: '${basePath}/admin/loan/completeDetainCar',
                data: {
