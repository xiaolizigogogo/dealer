            ...
            <div class="tab-pane active" id="tabcon-01">
                <form class="form-inline clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label>剩余还款总额：</label>${surplusRepaymentSum}元
                        </div>
                        <div class="form-group col-md-4">
                            <label>罚息总额：</label>${overdueFeeSum}元
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="label-s"><i class="text-danger">*</i>上传还款凭证截图<span
                            ...
                            <input id="repaymentUploadProofUpload" type="file"
                                   class="form-control"
                                   name="files[]"
                                   data-url="${basePath}/admin/file/upload/${repayment.uuid}/repaymentUploadProof.html"/>
                        </div>
                    </div>
                    <br/>
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            <c:if test="${repaymentFlag == true || repaymentFlag == null}">
                                &nbsp; &nbsp; &nbsp;
                                <button type="button" class="btn btn-01" name="submit1" id="submit1"
                                        onclick="javascript:repaymenting('commonRepayment')">正常还款
                                </button>
                            </c:if>
                            ...
                            <c:if test="${repaymentFlag == false}">
                                ...
                                <button type="button" class="btn btn-01" name="submit2" id="submit2"
                                        onclick="javascript:repaymenting('continueRepayment')">续借还款
                                </button>
                            </c:if>
                            ...
                            <c:if test="${repaymentFlag == true || repaymentFlag == null}">
                                ...
                                <button type="button" class="btn btn-01" name="submit3" id="submit3"
                                        onclick="javascript:repaymenting('advancedRepayment')">提前还款
                                </button>
                            </c:if>
                            &nbsp; &nbsp; &nbsp;
                                <button type="button" class="btn btn-01" name="submit3" id="submit3"
                                        onclick="javascript:repaymenting('abandonRepayment')">放弃还款
                                </button>
...
<script>
    ...
    function repaymenting(flag) {
        ...
        if((flag !="abandonRepayment")){
            if(repaymentUploadProof == '' || repaymentUploadProof == null){
                layer.msg("还款凭证必须上传！");
                return false;
            }
        ...
        layer.confirm(dialogMsg, {icon: 3, title: '提示'}, function () {
            ...
            $.ajax({
            type: 'POST',
            url: '${basePath}/admin/loan/completeRepaymenting',
            data: {
    ...
    $(function () {
        /** 加载附件 */
        $("#loan_attachment_div").load("${basePath}/admin/loan/getRepaymentUploadLoanAttachment.html?loanId=${repayment.uuid}", function () {
