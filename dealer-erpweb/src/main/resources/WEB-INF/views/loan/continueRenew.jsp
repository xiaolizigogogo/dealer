                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <button type="button" class="btn btn-01" name="submit1" id="submit1"
                                    onclick="javascript:continueRenew('repaymentedHandle')">同意续借
                            </button>
                            &nbsp; &nbsp; &nbsp;
                            <button type="button" class="btn btn-01" name="submit3" id="submit3"
                                    onclick="javascript:continueRenew('noPass')">拒绝续借
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    function continueRenew(flag) {
        ...
        if (flag == "repaymentedHandle") {
            reviewStatusStr = "同意续借"
        } else if (flag == "noPass") {
            reviewStatusStr = "拒绝续借"
        }
        ...
        layer.confirm(dialogMsg, {icon: 3, title: '提示'}, function () {
            ...
            $.ajax({
                type: 'POST',
                url: '${basePath}/admin/loan/completeContinueRenew',
                data: {
