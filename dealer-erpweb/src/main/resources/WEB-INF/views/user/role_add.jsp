...
<script>
    ...
    function saveOrUpdate() {
        ...
        if (roleName == null || roleName == "") {
        	alertMessage("请填写角色名称！","colsediv(0)");
        	return;
        }
...
<div class="col-lg-12">
  ...
  <form>
    ...
    <div class="form-group">
      ...
      <div class="clearfix">
        <input type="text" class="form-control" style=" width:30%;" id="roleName" name="roleName"  maxlength="10"
		...
		<div class="modal-body">
			...
			<div class="btn_list clearfix">
				...
				<a class="btn btn-default btn-sm"
					href="javascript:void(0)" onclick="colsediv(0)">确定</a>
			</div>
		</div>
	</div>
