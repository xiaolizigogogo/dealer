...
$(function () {
    ...
    pageComm = function (posturl, data, writetablefn, tc, colspan) {
        indata = data;
        inposturl = posturl;
        ...
        vcolspan = colspan;
         if(data.currentPage)
        {
        	if(curPage!=data.currentPage){
        		sessionStorage.setItem("SavePage_"+posturl, data.currentPage);
        	}
        }
       else if(typeof(curPage) != "undefined"&&data.claim=="claim")
       {
        	if(sessionStorage.getItem("SavePage_"+posturl)){
       		data.currentPage = sessionStorage.getItem("SavePage_"+posturl);
        	}
        }
    ...
    submitPage = function (currentPage) {
        ...
        pageComm(inposturl, indata, inwritetablefn, tbodyContext, vcolspan);
    };
});
