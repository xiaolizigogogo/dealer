    ...
    (function() {
      ...
      /* 函数 */ {
        ...
        var append = function(i/* String index */, t/* String tab */, h/* String href */, r/* String reload */) {
          ...
          if($ > -1) {
            ...
            jQuery(tabControl_main)      .append('<iframe src="' + h + '" scrolling="auto" frameborder="0" width="100%" id="main_ifream'+t+'"  onload="setIframeHeight(this)"   reload="' + r + '"></iframe>');
      ...
      /* 方法 */ {
        ...
        var change = function(e/* OBJECT event */) {
          ...
          //改变尺寸
         // jQuery(tabControl_main).css('height','800px');
